...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final KoltinLibraryAccessors laccForKoltinLibraryAccessors = new KoltinLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>iomockk</b> with <b>io.mockk:mockk</b> coordinates and
     * with version reference <b>ioMockk</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getIomockk() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("iomockk");
    }
    ...
    /**
     * Dependency provider for <b>klint</b> with <b>org.jlleitschuh.gradle:ktlint-gradle</b> coordinates and
     * with version reference <b>klint</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getKlint() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("klint");
    }
    ...
    /**
     * Group of libraries at <b>koltin</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KoltinLibraryAccessors getKoltin() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKoltinLibraryAccessors;
    }
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>actvity</b> with <b>androidx.activity:activity-compose</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getActvity() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.compose.actvity");
        }
    ...
    public static class GooglePlayLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getLocation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("google.play.location");
        }
     ...
     */
    @Deprecated
    public static class KoltinLibraryAccessors extends SubDependencyFactory {

        public KoltinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>coroutines</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-test</b> coordinates and
         * with version reference <b>kotlinCoroutine</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutines() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("koltin.coroutines");
        }
     ...
     */
    @Deprecated
    public static class PagingLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
    ...
    public static class SquareLibraryAccessors extends SubDependencyFactory {
        private final SquareMoshiLibraryAccessors laccForSquareMoshiLibraryAccessors = new SquareMoshiLibraryAccessors(owner);
        private final SquareRetrofitLibraryAccessors laccForSquareRetrofitLibraryAccessors = new SquareRetrofitLibraryAccessors(owner);

        public SquareLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>square.moshi</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SquareMoshiLibraryAccessors getMoshi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSquareMoshiLibraryAccessors;
        }

        /**
         * Group of libraries at <b>square.retrofit</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SquareRetrofitLibraryAccessors getRetrofit() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSquareRetrofitLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SquareMoshiLibraryAccessors extends SubDependencyFactory {
        private final SquareMoshiKotlinLibraryAccessors laccForSquareMoshiKotlinLibraryAccessors = new SquareMoshiKotlinLibraryAccessors(owner);

        public SquareMoshiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>square.moshi.kotlin</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SquareMoshiKotlinLibraryAccessors getKotlin() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSquareMoshiKotlinLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SquareMoshiKotlinLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public SquareMoshiKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kotlin</b> with <b>com.squareup.moshi:moshi-kotlin</b> coordinates and
         * with version reference <b>sqaureMoshi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("square.moshi.kotlin");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getCodegen() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("square.moshi.kotlin.codegen");
        }
     ...
     */
    @Deprecated
    public static class SquareRetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public SquareRetrofitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getMoshi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("square.retrofit.moshi");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>googlePlayLocation</b> with value <b>18.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleTruth</b> with value <b>1.4.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ioMockk</b> with value <b>1.13.11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIoMockk() { return getVersion("ioMockk"); }
        ...
        /**
         * Version alias <b>klint</b> with value <b>12.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKlint() { return getVersion("klint"); }
        ...
        /**
         * Version alias <b>kotlinCoroutine</b> with value <b>1.9.0-RC</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinCoroutine() { return getVersion("kotlinCoroutine"); }
        ...
        /**
         * Version alias <b>retrofitMoshi</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRetrofitMoshi() { return getVersion("retrofitMoshi"); }

        /**
         * Version alias <b>sqaureMoshi</b> with value <b>1.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSqaureMoshi() { return getVersion("sqaureMoshi"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>klint</b> with plugin id <b>org.jlleitschuh.gradle.ktlint</b> and
         * with version reference <b>klint</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKlint() { return createPlugin("klint"); }
